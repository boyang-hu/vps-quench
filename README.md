...
```bash
curl -fLO https://github.com/boyang-hu/vps-quench/releases/download/v0.1.4/quench-offline-V0.1.4.tar.gz
curl -fLO https://github.com/boyang-hu/vps-quench/releases/download/v0.1.4/quench-offline-V0.1.4.tar.gz.sha256
sha256sum -c quench-offline-V0.1.4.tar.gz.sha256
```

再通过 `scp`、SFTP 或 WinSCP 将两个文件传到 VPS。Linux/macOS 示例：

```bash
scp quench-offline-V0.1.4.tar.gz* root@你的VPS地址:/root/
```
...
cd /root
sha256sum -c quench-offline-V0.1.4.tar.gz.sha256
tar -xzf quench-offline-V0.1.4.tar.gz
cd quench-offline-V0.1.4
bash install.sh
v
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  VPS INIT/MANAGEMENT TOOLS  ·  V0.1.4  ·  Boyang
────────────────────────────────────────────────────────────────
